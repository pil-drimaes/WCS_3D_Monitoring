...
import com.example.cdcqueue.etl.ETLEngineException;
 ...
 */
@Component
public class InventoryDataETLEngine implements DataETLEngine<InventoryInfo> {
    ...
    public ETLStatistics getStatistics() {
        ...
        stats.setTotalProcessedRecords((int) getLastExecutionTime());
        return stats;
    }
} 